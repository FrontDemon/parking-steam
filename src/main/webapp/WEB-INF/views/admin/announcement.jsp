    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            ...
            <form style="text-align: center">
                <input class="input-text radius" style="width: 200px" type="text" name="key" placeholder="输入标题"/>
                <button class="btn btn-default">搜索标题</button>
            </form>
            <div class="bg-1" style="margin-top: 20px;padding: 10px">
                <button class="btn btn-default">添加公告</button>
                <p style="display: inline-block">共有数据：<span>11</span>条</p>
            </div>
            <table class="table table-border table-bordered table-hover table-bg">
                <caption class="bg-1">公告列表</caption>
                <thead>
                <tr>
                    <th>序号</th>
                    <th>标题</th>
