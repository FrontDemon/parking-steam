...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        ...
        <dl id="menu-member">
            ...
            <dd>
                <ul>
                    <li><a href="commentList" title="留言列表">留言列表</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-admin">
            ...
            <dd style="display: block">
                <ul>
                    ...
                    <li class="current"><a href="userList" title="用户列表">用户列表</a></li>
                </ul>
            </dd>
        </dl>
    </div>
...
<section class="Hui-article-box">
    <nav class="breadcrumb"><i class="Hui-iconfont"></i>
        ...
        <span class="c-999 en">&gt;</span><span class="c-666">系统管理</span>
        <span class="c-999 en">&gt;</span><span class="c-666">用户列表</span>
    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            ...
            <form style="text-align: center">
                <input class="input-text radius" style="width: 200px" type="text" name="key" placeholder="输入用户名称"/>
            ...
            <table class="table table-border table-bordered table-hover table-bg">
                ...
                <tr>
                    ...
                    <td>5</td>
                    <td>6</td>
                    <td><a class="ml-5" href="javascript:;" style="text-decoration:none" title="停用">
